...
$edit = "SELECT * FROM item WHERE item_id='$_GET[id]'";
...
<form id="image-form" method="POST" action="module/mod_item/update_item.php" enctype="multipart/form-data" data-abide>
	...
	<tr>
		<td>Deskripsi</td>
<div class="columns medium-6">
		<td><textarea name="deskripsi"><?php echo $r['description']; ?></textarea></td>
</div>
	</tr>
	<tr>
		<td>Harga</td>
