...
$edit = "SELECT * FROM souvenir WHERE souvenir_id='$_GET[id]'";
...
<form id="image-form" method="POST" action="module/mod_souvenir/update_souvenir.php" enctype="multipart/form-data" data-abide>
	<table width=100% cellpadding="8">
		<input type="hidden" name="id" value="<?php echo $r['souvenir_id']; ?>" required>
